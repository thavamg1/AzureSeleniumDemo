...
public class Report {
	...
	private String handleStepInvolvingScreenshot(String stepName, Status stepStatus) {
		String CurrTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSS")); 
		String screenshotName = reportSettings.getReportName() + "_"
				+ CurrTime.replace(" ", "_").replace(".", "_").replace(":", "-")
				+ "_" + stepName.replace(" ", "_").replace(":", "_") + ".png";
