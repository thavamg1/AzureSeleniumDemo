...
import com.theaa.dip.automation.ua.framework.ExcelDataAccessforxlsm;
...
public class Allocator {
	...
	public static String passwdkey;
	...
	/*	try {
			UAGeneralFunc.Env = System.getProperty("env");
			
			if(UAGeneralFunc.Env.isEmpty()) {
				UAGeneralFunc.Env="qa";
			}
			}catch(Exception e) {
				UAGeneralFunc.Env="qa";
			}*/
		...
		try {
			passwdkey = System.getProperty("pwdkey");
			}catch(Exception e) {
				passwdkey=null;
			}
