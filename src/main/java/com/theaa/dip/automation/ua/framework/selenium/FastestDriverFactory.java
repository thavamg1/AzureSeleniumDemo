...
import com.theaa.dip.automation.ua.allocator.Allocator;
...
//		desiredCapabilities.setCapability("password", mobileProperties.getProperty("MintPassword"));
		desiredCapabilities.setCapability("username", Allocator.userid);
		desiredCapabilities.setCapability("password", Allocator.passwdkey);
